...
import numpy as np
import os, shutil, warnings, glob, json, ast, warnings, sys
...
def _extract_melspec(in_file, win_size):
    ...
    sig, sr = librosa.load(in_file, sr=16000)
...
def predict_curSong(mp3_file):
    ...
    tag_tr_fp = os.path.join(os.path.dirname(__file__), 'data', 'data.magnatagatune', 'tag_list.top188.txt')
    tag_te_fp = os.path.join(os.path.dirname(__file__), 'data', 'data.magnatagatune', 'tag_list.top50.txt')
    ...
    # Files
    param_fp = os.path.join(os.path.dirname(__file__), 'data', 'models', 'model.20160309_111546.npz')
    tag_tr_fp = os.path.join(os.path.dirname(__file__), 'data', 'data.magnatagatune', 'tag_list.top188.txt')
    tag_te_fp = os.path.join(os.path.dirname(__file__), 'data', 'data.magnatagatune', f'tag_list.top{n_top_tags_te}.txt')
